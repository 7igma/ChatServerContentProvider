...
public class AsyncContentResolver extends AsyncQueryHandler {
    ...
    public void insertAsync(Uri uri,
                            ...
                            IContinue callback) {
        Log.i("AsyncContentResolver", "insertAsync: calling startInsertAsync");
    ...
    public void queryAsync(Uri uri, String[] columns, String select, String[] selectArgs, String order, SimpleQueryBuilder.ISimpleQueryListener<Peer> listener) {
